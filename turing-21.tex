...
\frame{
	...
	\begin{itemize}
		\item Lets consider a what happens if we \textbf{only} considered the error of the optimal joint-action.
	\end{itemize}
	\begin{center}
		\begin{tabular}{ | c | c | c |}
			\hline
	...
	\begin{itemize}
		...
		\item Ideally, we also want to learn $Q$-values for the other joint-actions that are below.
	\end{itemize}
